...
import { mockCompany, mockUser, portalNavigation } from "@/data/portal";
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-72 border-r border-slate-200 bg-slate-950 text-white lg:flex lg:flex-col">
        ...
        <div className="border-t border-white/10 p-4">
          <div className="rounded-lg bg-white/5 p-4">
            <p className="text-sm font-semibold">{mockCompany.name}</p>
            <p className="mt-1 text-xs text-slate-400">{mockCompany.plan}</p>
          </div>
        </div>
      </aside>
