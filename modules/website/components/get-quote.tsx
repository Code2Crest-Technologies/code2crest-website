              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div data-aos="fade-up" data-aos-delay={200}>
                  ...
                  <input
                    ...
                    required
                    className="form-input h-11 w-full rounded-lg border border-gray-600/50 bg-gray-800/50 px-4 text-white placeholder-gray-500 transition focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  />
                </div>
