  ...
  return (
    <section id="home" className="relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="pb-16 pt-20 md:pb-24 md:pt-28 lg:pb-28 lg:pt-32">

          {/* Hero Content */}
          <div className="mx-auto max-w-[900px] text-center">
            <h1
              className="pb-7 text-4xl font-bold leading-tight text-white md:text-6xl md:leading-[1.08]"
              data-aos="fade-up"
            >
            ...
            <p
              className="mx-auto mb-11 max-w-[720px] text-lg leading-8 text-slate-300 md:text-xl md:leading-9"
              data-aos="fade-up"
              data-aos-delay={200}
            >
            ...
            >
              ...
              <a
                href="#contact"
                className="group inline-flex h-12 min-w-40 items-center justify-center rounded-full border border-indigo-500/30 bg-indigo-600/10 px-7 text-sm font-semibold text-indigo-300 transition duration-300 hover:border-indigo-400/60 hover:bg-indigo-600/20 hover:text-indigo-200 hover:shadow-[0_0_20px_-5px_rgba(99,102,241,0.4)]"
              >
                Contact Us
              </a>
            </div>
